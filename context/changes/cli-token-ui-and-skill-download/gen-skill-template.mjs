...
const SRC = 'context/changes/cli-token-ui-and-skill-download/eggplant-notes.skill.md'
const OUT = 'src/features/api-tokens/skill-template.ts'

const md = readFileSync(SRC, 'utf8')

const header = `// The agent skill served by GET /api/skill, with {{BASE_URL}} replaced by the deployment origin.
//
...
export const SKILL_TEMPLATE = ${JSON.stringify(md)}
`
