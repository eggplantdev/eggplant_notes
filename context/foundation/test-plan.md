...
| 7   | Markdown render XSS guard          | Prove untrusted markdown (imported file, AI body) renders inert — no script execution, dangerous URLs neutralized | #7 (complements #3)            | e2e (paste & observe)                                            | implementing | context/changes/testing-markdown-xss-guard/                    |
