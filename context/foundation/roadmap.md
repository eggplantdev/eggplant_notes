...
| S-17 | topic-checks-listing           | browse all recall cards on a `/topic-checks` page, filtered by subject server-side; jump from a card to its source note    | S-02, S-06, S-08                   | US-01, Scope:[new] card→note (listing)         | v2          | done     |
