...
| S-14       | inline-edit-notes-and-subjects | In-place edit for notes + subjects; kill /edit routes | planned                | v2 UX. Plan + research + handoff authored (`eb394bf`) in `context/changes/inline-edit-notes-and-subjects/`; ready for `/10x-implement`. searchParam-driven; checks keep inline CRUD.                                                                                                                                                                                                                                                        |
