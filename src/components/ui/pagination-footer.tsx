...
// Renders nothing for a single page — the PageShell subtitle already carries the total count.
export function PaginationFooter({ paginationMeta, baseUrl, className }: PaginationFooterPropsT) {
  ...
  // not "Showing 2353–30 of 30" — parsePagination clamps only the lower bound, so upper overflow reaches here.
