...
import type { CreateNoteWithChecksT } from '@/features/notes/schemas'
import type { Database } from '@/lib/supabase/types'

// Shared write core for "note + its checks", reused by the createNote Server Action (cookie client) and
...
export async function insertNoteWithChecks(
  supabase: SupabaseClient<Database>,
  { note, checks }: CreateNoteWithChecksT,
): Promise<string> {
