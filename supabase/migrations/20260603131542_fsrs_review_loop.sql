-- S-03 close-recall-loop: migrate memory_cards scheduling state SM-2 -> FSRS.
...
-- ============================================================================
-- memory_cards: SM-2 columns -> FSRS state
...
alter table memory_cards add column stability real not null default 0;
alter table memory_cards add column difficulty real not null default 0;
alter table memory_cards add column elapsed_days integer not null default 0;
alter table memory_cards add column scheduled_days integer not null default 0;
alter table memory_cards add column learning_steps integer not null default 0;
alter table memory_cards add column reps integer not null default 0;
alter table memory_cards add column lapses integer not null default 0;
alter table memory_cards add column state smallint not null default 0;
alter table memory_cards add column last_review timestamptz;
...
-- ============================================================================
-- public.record_review(p_memory_card_id, p_rating, p_card)
...
-- them (update memory_cards + insert review_events) in one transaction.
--
